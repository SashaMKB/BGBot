...
# bonus
dms_url = hlink("ДМС", "https://conf.bars.group/pages/viewpage.action?pageId=167862245")
referalprogram_url = hlink("Реферальная программа", "https://conf.bars.group/pages/viewpage.action?pageId=167851490")
code_url = hlink("БАРС-Код", "https://t.me/barskodbarsgroup")
biblio_url = hlink("Библиотека", "https://t.me/barsbiblioteka")
